...
Note: We currently support only TMC 11.0 version (https://github.com/MPEGGroup/mpeg-pcc-tmc2) and C2 intra coding conditions (lossy geometry, lossy attributes). The dimensions of the encoded video frames shall not change over an encoded sequence.
