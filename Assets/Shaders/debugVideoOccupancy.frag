...
float sample_occupancy(vec2 uv)
{
...
void main()
{
    float occupancy_sample = sample_occupancy(v_tex_coord);

    outputFragmentColor = vec4(occupancy_sample, occupancy_sample, occupancy_sample, 1.0);
}
