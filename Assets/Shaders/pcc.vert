...
// Attributes
layout (location = 0) in ivec2 a_block_uv;
layout (location = 1) in ivec2 a_patch_u0v0;
layout (location = 2) in ivec3 a_patch_u1v1d1;
layout (location = 3) in ivec3 a_projection;

// x = u0
// y = v0
// z = 0
// w = 0
layout (location = 4) in ivec4 a_patch_size_u0v0;

// x = orientation
// y = occupancy resolution
// z = depth projection mode
// w = 0
layout (location = 5) in ivec4 a_patch_properties;
